...
import { saveSurgery, type ProcedureInput } from '@/app/actions/surgeries'
...
function emptyProcedure(): ProcedureInput {
  return {
...
export default function NovaCirurgiaForm() {
  ...
  const [procedures, setProcedures] = useState<ProcedureInput[]>([emptyProcedure()])
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await saveSurgery({
        date,
        specialty,
